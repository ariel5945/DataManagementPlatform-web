<template>
  <div class="box">
    <ItemWrap title="重点网络零售企业店铺排行(万元)" :style=styleObj>
        <div id="shopMaim" style="width: 544px; height:380px ;"></div>
    </ItemWrap>
  </div>
</template>
...
export default {
  ...
  methods: {
    getshopMaim() {
      let shopChart = echarts.init(document.getElementById("shopMaim"));
      let option = {
        grid: {
          top: "2%",
        },
      ...
      shopChart && shopChart.setOption(option);
